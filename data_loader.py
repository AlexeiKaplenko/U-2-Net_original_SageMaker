...
class RescaleT(object):
	...
	def __call__(self,sample):
		...
		image = transforms.Resize(self.output_size, interpolation=Image.BICUBIC)(image)
		label = transforms.Resize(self.output_size, interpolation=Image.BICUBIC)(label)
		...
		# print('rescalet_image_max', np.max(sample['image']))
		# print('rescalet_label_max', np.max(sample['label']))
		# print('rescalet_prior_max', np.max(sample['prior']))
...
class ColorJitter(object):
	...
	def __call__(self,sample):
		...
		# print('ColorJitter_image_shape', image.shape)
